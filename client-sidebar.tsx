...
import { LayoutDashboard, CheckCircle, Receipt, Settings, LogOut, Briefcase } from 'lucide-react';
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@/components/ui/tooltip';
import CardanoLogo from './icons/cardano-logo';
import { cn } from '@/lib/utils';

const navItems = [
  { href: '/client/dashboard', icon: LayoutDashboard, label: 'Active Projects' },
  { href: '/client/dashboard/past-projects', icon: CheckCircle, label: 'Past Projects' },
  { href: '/client/dashboard/transaction-history', icon: Receipt, label: 'Transactions' },
